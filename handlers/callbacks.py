...
@router.callback_query(StateFilter(Greeting.rating_page), F.data.startswith("main_info_ratings"))
...
@router.callback_query(StateFilter(Greeting.notifications_ratings_page), F.data.startswith("subscribe_ratings_"))
